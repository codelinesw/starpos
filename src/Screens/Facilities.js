...
export default class Facilities extends React.Component{
	...
	getData(){
		const URL = `http://localhost:8089/ORM/facilities_/list/`;
				...
				<div className="card border-0 mt-1">
					<div className="card-header bg-transparent">
						<div className="d-flex justify-content-between mb-2 p-0">
							<h2 className="mb-3">Sedes</h2>
							<Link to="/addfacilities/" className="btn btn-primary mt-1" style={{height:'42px'}}>+ Agregar</Link>
						</div>
						<div className="search-bar">
							<div className="input-group mb-3">
								...
								<input type="text" className="form-control" placeholder="Busca por Codigo o por Ubicacion" aria-label="Example text with button addon" aria-describedby="button-addon1" />								  																		  
							</div>
						</div>
